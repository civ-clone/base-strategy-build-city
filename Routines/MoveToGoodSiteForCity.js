...
var _MoveToGoodSiteForCity_cityRegistry, _MoveToGoodSiteForCity_pathFinderRegistry, _MoveToGoodSiteForCity_ruleRegistry, _MoveToGoodSiteForCity_strategyNoteRegistry;
...
class MoveToGoodSiteForCity extends Routine_1.default {
    constructor(cityRegistry = CityRegistry_1.instance, pathFinderRegistry = PathFinderRegistry_1.instance, ruleRegistry = RuleRegistry_1.instance, strategyNoteRegistry = StrategyNoteRegistry_1.instance) {
        ...
        _MoveToGoodSiteForCity_ruleRegistry.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _MoveToGoodSiteForCity_ruleRegistry, ruleRegistry, "f");
    ...
    attempt(action) {
        ...
        const [target] = note
            ...
            (0, goodSiteForCity_1.goodSiteForCity)(unit.player(), unit.tile(), undefined, __classPrivateFieldGet(this, _MoveToGoodSiteForCity_cityRegistry, "f")))
            .sort(([, distanceA], [, distanceB]) => distanceA - distanceB)
            .map(([tile]) => tile);
        if (!target) {
            return false;
        }
        const goTo = new GoTo_1.default(unit.tile(), target, unit, __classPrivateFieldGet(this, _MoveToGoodSiteForCity_ruleRegistry, "f"), __classPrivateFieldGet(this, _MoveToGoodSiteForCity_pathFinderRegistry, "f"), __classPrivateFieldGet(this, _MoveToGoodSiteForCity_strategyNoteRegistry, "f"));
        goTo.perform();
        return true;
    }
}
exports.MoveToGoodSiteForCity = MoveToGoodSiteForCity;
_MoveToGoodSiteForCity_cityRegistry = new WeakMap(), _MoveToGoodSiteForCity_pathFinderRegistry = new WeakMap(), _MoveToGoodSiteForCity_ruleRegistry = new WeakMap(), _MoveToGoodSiteForCity_strategyNoteRegistry = new WeakMap();
